...
<li class="nav-item dropdown">
 ...
 <li><a class="dropdown-item" href="admintrip.php">Trip Details</a></li>
    ...
    $conn = oci_connect($user, $password, $connectionString);
            ...
            $sql = "SELECT * FROM DRIVER WHERE (UPPER(DRIVER_ID) LIKE '%$searchTerm%' OR UPPER(DRIVER_NAME) LIKE '%$searchTerm%' OR UPPER(QUALIFICATION) LIKE '%$searchTerm%' OR UPPER(AVAILABILITY) LIKE '%$searchTerm%')";
        } 
            else {
