...
$query = "SELECT LEAVE.LEAVE_ID, LEAVE.TYPE_OF_LEAVE, LEAVE.LEAVE_DUE, LEAVE.START_DATE, LEAVE.END_DATE, (LEAVE.END_DATE - LEAVE.START_DATE) AS DURATION, DRIVER.DRIVER_ID FROM LEAVE, DRIVER WHERE LEAVE.DRIVER_ID = DRIVER.DRIVER_ID";
