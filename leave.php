...
$query = "SELECT LEAVE.LEAVE_ID, LEAVE.TYPE_OF_LEAVE, LEAVE.LEAVE_DUE, LEAVE.START_DATE, LEAVE.END_DATE, (LEAVE.END_DATE - LEAVE.START_DATE) AS DURATION, DRIVER.DRIVER_ID FROM LEAVE, DRIVER WHERE DRIVER.UNIT_NAME = UPPER(:username) AND LEAVE.DRIVER_ID = DRIVER.DRIVER_ID";
$statement = oci_parse($conn, $query);

// Bind the :username placeholder with the $username variable
...
oci_execute($statement);
    ...
    <a href="editleave.php" class="btn btn-primary btn-update">Update</a>
</div>
